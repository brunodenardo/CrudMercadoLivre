    ...
    def menu(self):
        ...
        while(sub != 'V'):
            ...
            if (sub == '1'):
                ...
                usuario_id = self.crudUsuario.selecionaId("exibir as compras")
                ...
                usuario_id = self.crudUsuario.selecionaId("inserir um produto nas compras desse usuário")
                if usuario_id == "C":
                    print("\nOperação cancelada\n")
                elif usuario_id == "Não há ninguém cadastrado":
                    print(usuario_id)
                else:
                    produto = self.crudProduto.selecionaProdutoResumido("adicionar as compras de um usuário")
                    if produto == "C":
                        print("\nOperação cancelada\n")
